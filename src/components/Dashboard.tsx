...
export function Dashboard() {
  ...
  return <>
    ...
    <div className="relative z-20 min-h-screen">
      <aside className={`group fixed inset-y-0 left-0 z-40 border-r border-border bg-surface px-3 py-5 shadow-xl transition-[width] duration-200 ${sidebarPinned ? 'w-64' : 'w-20 hover:w-64'}`}>
      ...
      <div className={`relative z-20 min-w-0 transition-[margin-left] duration-200 ${sidebarPinned ? 'ml-64' : 'ml-20'}`}>
